...
\begin{df}[Lower Limit Topology on the Real Line]
...
\begin{df}[$K$-topology on the Real Line]
...
\begin{df}[Product Topology]
    Let $X$ and $Y$ be topological spaces. The \emph{product topology} on $X \times Y$ is the topology
    generated by the basis $\BB$ consisting of all sets $U \times V$ such that $U$ is open in $X$ and
    $V$ is open in $Y$.
\end{df}

We prove that this is a basis for a topology.

\begin{proof}
    \pf
    \step{1}{For all $(x,y) \in X \times Y$ there exists $B \in \BB$ such that $(x,y) \in B$}
    \begin{proof}
        \pf\ Take $B = X \times Y$.
    \end{proof}
    \step{2}{For all $B_1, B_2 \in \BB$ and $(x,y) \in B_1 \cap B_2$, there exists $B_3 \in \BB$
    such that $(x,y) \in B_3 \subseteq B_1 \cap B_2$}
    \begin{proof}
...
\begin{theorem}
    If $\BB$ is a basis for the topology of $X$ and $\CC$ is a basis for the topology of $Y$, then
    \[ \DD = \{ B \times C \mid B \in \BB, C \in \CC \} \]
    is a basis for the product topology on $X \times Y$.
\end{theorem}

\begin{proof}
    \pf
    \step{1}{Every member of $\DD$ is open in the product topology.}
    \begin{proof}
        \pf\ By definitions.
    \end{proof}
    \step{2}{For every open set $U$ and point $(x,y) \in U$, there exists $D \in \DD$ such that $(x,y)
    \in D \subseteq U$.}
    \begin{proof}
        \step{a}{\pflet{$U$ be open and $(x,y) \in U$}}
        \step{b}{\pick\ $W$ open in $X$ and $V$ open in $Y$ with $(x,y) \in W \times V \subseteq U$}
        \step{c}{\pick\ $B \in \BB$ with $x \in B \subseteq W$}
        \step{d}{\pick\ $C \in \CC$ with $y \in C \subseteq V$}
        \step{e}{$(x,y) \in B \times C \subseteq U$}
    \end{proof}
    \qedstep
    \begin{proof}
...
\begin{df}[Standard Topology on the Plane]
    The \emph{standard topology} on $\RR^2$ is the product topology of the standard topology on $\RR$
    with itself.
\end{df}
...
\begin{lemma}
    ...
    The set
    \[ \mathcal{S} = \{ U \times Y \mid U \text{ open in } X \} \cup
    \{ X \times V \mid V \text{ open in } Y \} \]
...
\begin{proof}
    ...
    \begin{proof}
        \pf\ From defintions.
    \end{proof}
    \step{2}{Every basic open set is a finite intersection of members of $\mathcal{S}$.}
    \begin{proof}
        \pf\ Given $U$ open in $X$ and $V$ open in $Y$, we have $U \times V = (U \times Y) \cap (X \times V)$.
    \end{proof}
    \qed
\end{proof}

\begin{proposition}
    \label{proposition:projections_open_maps}
    For any topological spaces $X$ and $Y$, the projections $\pi_1 : X \times Y \rightarrow X$ and
    $\pi_2 : X \times Y \rightarrow Y$ are open maps.
\end{proposition}
...
\begin{proof}
    ...
    \begin{proof}
        \step{1}{\pflet{$U$ be open in $X \times Y$.}}
        \step{2}{\pflet{$x \in \pi_1(U)$}}
        \step{3}{\pick\ $y \in Y$ such that $(x,y) \in U$.}
        \step{4}{\pick\ $V$ open in $X$ and $W$ open in $Y$ such that $(x,y) \in V \times W \subseteq U$.}
        \step{5}{$x \in V \subseteq \pi_1(U)$}
        \begin{proof}
            \step{a}{\pflet{$v \in V$}}
            \step{b}{$(v,y) \in V \times W$}
            \begin{proof}
                \pf\ $y \in W$ from \stepref{4}.
            \end{proof}
            \step{c}{$(v,y) \in U$}
            \begin{proof}
                \pf\ From \stepref{4}.
...
\begin{proposition}
    Let $\TT$ and $\TT'$ be topologies on a nonempty set $X$, and $\UU$ and $\UU'$ be topologies on a 
    nonempty set $Y$.
    Then $\TT \subseteq \TT'$ and $\UU \subseteq \UU'$ if and only if the product topology generated
    by $\TT$ and $\UU$ is coarser than the product topology generated by $\TT'$ and $\UU'$.
\end{proposition}

\begin{proof}
    \pf
    \step{1}{\pflet{$\mathcal{P}$ be the topology generated by $\TT$ and $\UU$, and $\mathcal{P}'$ the
    product topology generated by $\TT'$ and $\UU'$}}
    \step{2}{If $\TT \subseteq \TT'$ and $\UU \subseteq \UU'$ then $\mathcal{P} \subseteq \mathcal{P}'$}
    \begin{proof}
        \pf\ By Corollary \ref{cor:basis_open}.
    \end{proof}
    \step{3}{If $\mathcal{P} \subseteq \mathcal{P}'$ then $\TT \subseteq \TT'$ and $\UU \subseteq \UU'$}
    \begin{proof}
        \step{a}{\assume{$\mathcal{P} \subseteq \mathcal{P}'$}}
        \step{b}{$\TT \subseteq \TT'$}
        \begin{proof}
            \step{i}{\pflet{$U \in \TT$}}
            \step{ii}{$U \times Y \in \mathcal{P}$}
            \step{iii}{$U \times Y \in \mathcal{P}'$}
            \begin{proof}
                \pf\ By \stepref{a}
            \end{proof}
            \step{iv}{$U \in \TT'$}
            \begin{proof}
                \pf\ By Proposition \ref{proposition:projections_open_maps}.
            \end{proof}
        \end{proof}
        \step{c}{$\UU \subseteq \UU'$}
        \begin{proof}
            \pf\ Similar.
        \end{proof}
    \end{proof}
...
\begin{theorem}
    If $A$ is a subspace of $X$ and $B$ is a subspace of $Y$ then the product topology on $A \times B$ is the
    same as the topology it inherits as a subspace of $X \times Y$.
\end{theorem}

\begin{proof}
    \pf\ The product topology is generated by
    \begin{align*}
        & \{ U \times V \mid U \text{ open in } A, V \text{ open in } B \} \\
        = & \{ (U' \cap A) \times (V' \cap B) \mid U' \text{ open in } X, V' \text{ open in } Y \} \\
        = & \{ (U' \times V') \cap (A \times V) \mid U' \text{ open in } X, V' \text{ open in } Y \}
    \end{align*}
    and this is a basis for the subspace topology by Lemma \ref{lemma:subspace_basis}. \qed
\end{proof}

\begin{theorem}
    Let $X$ be an ordered set in the order topology. Let $Y \subseteq X$ be convex. Then the order topology
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \qedstep
        \begin{proof}
            \pf\ By Lemmas \ref{lemma:open_rays_subbasis} and \ref{lemma:subspace_subbasis} and Corollary
            \ref{cor:subbasis_coarsest}.
        \end{proof}
    \end{proof}
    ...
    \begin{proof}
        ...
        \qedstep
        \begin{proof}
            \pf\ By Lemma \ref{lemma:open_rays_subbasis} and Corollary \ref{cor:subbasis_coarsest}
        \end{proof}
    \end{proof}
    \qed
\end{proof}
...
\begin{proof}
    \pf
    \[ (X \times Y) \setminus (A \times B) = ((X \setminus A) \times Y) \cup (X \times (Y \setminus B)) \qed \]
\end{proof}
...
\begin{proof}
    ...
    \begin{proof}
        \pf\ This follows from Theorem \ref{theorem:closure_open} since every element of $\BB$ is open
    ...
    \begin{proof}
        ...
        \qedstep
        \begin{proof}
            \pf\ By Theorem \ref{theorem:closure_open}.
        \end{proof}
    \end{proof}
    \qed
\end{proof}
...
\begin{proof}
    ...
    \begin{proof}
        ...
        \begin{proof}
            \pf\ From \stepref{a} and Theorem \ref{theorem:closure_open}.
        \end{proof}
        ...
        \qedstep
        \begin{proof}
            \pf\ We have $x \in \overline{B}$ from Theorem \ref{theorem:closure_open}.
        \end{proof}
    \end{proof}
    \qed
\end{proof}
...
\begin{proposition}
    Let $X$ and $Y$ be topological spaces.
    Let $A \subseteq X$ and $B \subseteq Y$. Then \[ \overline{A \times B} = \overline{A} \times \overline{B} \]
\end{proposition}
...
\begin{proof}
    ...
    \begin{proof}
        \step{a}{$A \subseteq \overline{A}$}
        \begin{proof}
            \pf\ Lemma \ref{lemma:closure_subset}.
        \end{proof}
        \step{b}{$B \subseteq \overline{B}$}
        \begin{proof}
            \pf\ Lemma \ref{lemma:closure_subset}.
        \end{proof}
        \step{c}{$A \times B \subseteq \overline{A} \times \overline{B}$}
        \step{d}{$\overline{A \times B} \subseteq \overline{A} \times \overline{B}$}
        \begin{proof}
            \pf\ Since $\overline{A} \times \overline{B}$ is closed by Proposition \ref{proposition:closed_product}.
        \end{proof}
    \end{proof}
    \step{2}{$\overline{A} \times \overline{B} \subseteq \overline{A \times B}$}
    \begin{proof}
        \step{a}{\pflet{$x \in \overline{A}$ and $y \in \overline{B}$}}
        \step{b}{\pflet{$U$ be a neighbourhood of $(x,y)$}}
        \step{c}{\pick\ $V$ open in $X$ and $W$ open in $Y$ such that $(x,y) \in V \times W \subseteq U$}
        \step{d}{$V$ intersects $A$}
        \begin{proof}
            \pf\ By Theorem \ref{theorem:closure_open} and \stepref{a}.
        \end{proof}
        \step{e}{$W$ intersects $B$}
        \begin{proof}
            \pf\ By Theorem \ref{theorem:closure_open} and \stepref{a}.
        \end{proof}
        \step{f}{$U$ intersects $A \times B$}
        \qedstep
        \begin{proof}
            \pf\ By Theorem \ref{theorem:closure_open}.
        \end{proof}
...
\begin{proof}
    \pf\ From Theorem \ref{theorem:closure_open}. \qed
\end{proof}
...
\begin{proof}
    ...
    \begin{proof}
        \pf\ From Theorem \ref{theorem:closure_open}.
    \end{proof}
...
\begin{proof}
    ...
    \begin{proof}
        \pf\ Theorem \ref{theorem:closure_open}.
    \end{proof}
    \step{5}{$b \in U$}
    \qedstep
    \begin{proof}
...
\begin{proof}
    ...
    \step{2}{\pflet{$(x_1, y_1)$ and $(x_2, y_2)$ be distinct points in $X \times Y$}}
    \step{3}{\assume{w.l.o.g.~$x_1 \neq x_2$}}
    \step{4}{\pick\ disjoint neighbourhoods $U$ of $x_1$ and $V$ of $x_2$.}
    \step{5}{$U \times Y$ and $V \times Y$ are disjoint neighbourhoods of $(x_1, y_1)$ and $(x_2, y_2)$.}
    \qed
\end{proof}
...
\begin{theorem}[Pasting Lemma]
    Let $X$ and $Y$ be topological spaces. Let $A$ and $B$ be closed subspaces of $X$ such that $X = A \cup B$.
    Let $f : A \rightarrow Y$ and $g : B \rightarrow Y$ be continuous. Suppose $f$ and $g$ agree on
    $A \cap B$. Define $h : X \rightarrow Y$ by
    \[ h(x) = \begin{cases}
        f(x) & \text{if } x \in A \\
        g(x) & \text{if } x \in B
    \end{cases} \]
...
\begin{theorem}
    Let $f : X \rightarrow Y \times Z$. If $\pi_1 \circ f$ and $\pi_2 \circ f$ are continuous then $f$
    is continuous.
\end{theorem}

\begin{proof}
    \pf
    \step{1}{\pflet{$U$ be open in $Y$ and $V$ open in $Z$}}
    \step{2}{$\inv{f}(U \times V) = \inv{(\pi_1 \circ f)}(U) \cap \inv{(\pi_2 \circ f)}(V)$}
    \step{2}{$\inv{f}(U \times V)$ is open in $X$.}
    \qedstep
    \begin{proof}
        \pf\ Proposition \ref{proposition:continuous_basis}.
    \end{proof}
    \qed
\end{proof}

\begin{proposition}
    Let $f : \RR \rightarrow \RR$ and $x \in \RR$. Then $f$ is continuous at $x$ if and only if,
    for all $\epsilon > 0$, there exists $\delta > 0$ such that. for all $y \in \RR$, if
    $|x-y| < \delta$ then $|f(x) - f(y)| < \epsilon$.
\end{proposition}

\begin{proof}
    \pf
    \step{1}{If $f$ is continuous at $x$ then, for all $\epsilon > 0$, there exists $\delta > 0$ such that. for all $y \in \RR$, if
    $|x-y| < \delta$ then $|f(x) - f(y)| < \epsilon$}
    \begin{proof}
        \step{a}{\assume{$f$ is continuous.}}
        \step{b}{\pflet{$\epsilon > 0$}}
        \step{c}{$\inv{f}((f(x) - \epsilon, f(x) + \epsilon))$ is open.}
        \step{d}{\pick\ $a$, $b$ such that $x \in (a,b) \subseteq \inv{f}((f(x) - \epsilon, f(x) +
        \epsilon))$}
        \step{e}{\pflet{$\delta = \min(x - a, b - x)$}}
        \step{f}{\pflet{$y \in \RR$ with $|x-y| < \delta$}}
        \step{g}{$y \in (a,b)$}
        \step{h}{$f(y) \in (f(x) - \epsilon, f(x) + \epsilon)$}
        \step{i}{$|f(x)-f(y)| < \epsilon$}
    \end{proof}
    \step{2}{Suppose, for all $\epsilon > 0$, there exists $\delta > 0$ such that. for all $y \in \RR$, if
    $|x-y| < \delta$ then $|f(x) - f(y)| < \epsilon$. Then $f$ is continuous at $x$.}
    \begin{proof}
        \step{a}{\assume{For all $\epsilon > 0$, there exists $\delta > 0$ such that. for all $y \in \RR$, if
        $|x-y| < \delta$ then $|f(x) - f(y)| < \epsilon$}}
        \step{b}{\pflet{$V$ be a neighbourhood of $f(x)$}}
        \step{c}{\pick\ $a$, $b$ such that $f(x) \in (a,b) \subseteq V$}
        \step{d}{\pflet{$\epsilon = \min(f(x)-a,b-f(x))$}}
        \step{e}{\pick\ $\delta > 0$ such that, for all $y \in \RR$, if $|x-y|<\delta$ then 
        $|f(x)-f(y)| < \epsilon$}
        \step{f}{\pflet{$U = (x - \delta, x + \delta)$}}
        \step{g}{$x \in U \subseteq \inv{f}(V)$}
    \end{proof}
    \qed
\end{proof}
