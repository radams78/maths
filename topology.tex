...
\begin{proposition}
    ...
    Let $X$ be a $T_1$ space. Then $X$ is regular if and only if, for any closed
...
\begin{proof}
    ...
    \begin{proof}
        \step{a}{$\{ U \in \BB \mid \overline{U} \cap V = \emptyset \}$ is a countable
        set of open sets that covers $A$}
        \begin{proof}
            \step{i}{\pflet{$x \in A$}}
            \step{ii}{\pick\ a neighbourhood $V$ of $x$ such that $\overline{V} \subseteq X - B$}
            \begin{proof}
                \pf\ By regularity.
            \end{proof}
            \step{iii}{\pick\ $U \in \BB$ such that $x \in U \subseteq V$}
            \begin{proof}
                \pf\ Since $\BB$ is a basis.
            \end{proof}
            \step{iv}{$\overline{U} \cap V = \emptyset$}
            \begin{proof}
                \pf\ Since $\overline{U} \subseteq \overline{V} \subseteq X - B$.
            \end{proof}
        \end{proof}
    \end{proof}
