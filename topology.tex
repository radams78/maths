...
\begin{lemma}
    \label{lemma:Hausdorff_compact_separation}
    If $Y$ is a compact subspace of a Hausdorff space $X$ and $x_0 \in
    X \setminus Y$ then there exist disjoint open sets $U$ and $V$ with
    $x_0 \in U$ and $Y \subseteq V$.
\end{lemma}

\begin{proof}
    \pf
    \step{1}{For all $y \in Y$ there exist disjoint open sets $U'$,
    $V'$ with $x_0 \in U'$ and $y \in V'$}
    \step{2}{$\{ V' \text{ open in } X \mid \text{there exists
    $U'$ open in $X$ with $x_0 \in U'$ and $U' \cap V' = \emptyset$} \}$
    covers $Y$}
    \step{3}{\pick\ a finite subcover $\{ V_1, \ldots, V_n \}$}
    \begin{proof}
        \pf\ Lemma \ref{lemma:finite_subcovering_subspace}.
    \end{proof}
    \step{4}{For $i = 1, \ldots, n$, \pick\ $U_i$ open in $X$ with
    $x_0 \in U_i$ and $U_1 \cap V_i = \emptyset$}
    \step{5}{Take $U = U_1 \cap \cdots \cap U_n$ and
...
\begin{proof}
    \pf
    \step{1}{For every $y \in Y$, there exist open sets $U$ in $X$ and
    $V$ in $Y$ such that $a \in U$, $y \in V$ and $U \times V \subseteq N$.}
    \step{2}{$\{ V \text{ open in } Y \mid \text{there exists $U$ open In
    $X$ such that $a \in U$ and $U \times V \subseteq N$} \}$ covers $Y$.}
    \step{3}{\pick\ a finite subcovering $\{ V_1, \ldots, V_n \}$}
    \step{4}{For $i = 1, \ldots, n$, \pick\ a neighbourhood $U_i$ of $a$
    such that $U_1 \times V_i \subseteq N$}
    \step{5}{\pflet{$W = U_1 \cap \cdots \cap U_n$}}
    \step{6}{$W \times Y \subseteq N$}
    \qed
\end{proof}
...
\begin{proof}
    \pf
    \step{1}{For all $x \in A$, there exist disjoint open sets $U'$ and $V'$
    with $x \in U'$ and $B \subseteq V'$}
    \begin{proof}
        \pf\ Lemma \ref{lemma:Hausdorff_compact_separation}
    \end{proof}
    \step{2}{$\{ U' \text{ open in } X \mid \exists V' \text{ open in } Y.
    U' \cap V' = \emptyset \text{ and } B \subseteq V' \}$ covers $A$.}
    \step{3}{\pick\ a finite subcover $\{ U_1, \ldots, U_n \}$}
    \step{4}{For $i=1, \ldots, n$, \pick\ $V_i$ open in $Y$ such that
    $U_i \cap V_i = \emptyset$ and $B \subseteq V_i$}
    \step{5}{\pflet{$U = U_1 \cup \cdots \cup U_n$}}
    \step{6}{\pflet{$V = V_1 \cup \cdots \cup V_n$}}
    \step{7}{$U$ and $V$ are disjoint open sets that include $A$ and $B$
    respectively.}
    \qed
\end{proof}
...
\begin{proof}
    ...
    \step{3}{For all $y \in Y$, there exist neighbourhoods $U$ of $x$ and $V$ of $y$ such that $U \times V$ is disjoint from $A$}
    \step{4}{$\{ V \text{ open in } Y \mid \exists { neighbourhood } U \text{ of } x. U \times V \cap A = \emptyset \}$ covers $Y$.}
    \step{5}{\pick\ a finite subcover $\{ V_1, \ldots, V_n \}$}
    \step{6}{For $i = 1, \ldots, n$, \pick\ a neighbourhood $U_i$ of $x$ such that $U_i \times V_i$ is disjoint from $A$.}
    \step{7}{\pflet{$U = U_1 \cap \cdots \cap U_n$}}
