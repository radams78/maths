...
\begin{proof}
    ...
    \begin{proof}
        \step{a}{\assume{as induction hypothesis there exist $V_1$, \ldots, $V_k$ such that $\overline{V_i} \subseteq U_i$ for $1 \leq i \leq k$
        and $(V_1, \ldots, V_k, U_{k+1}, \ldots, U_n)$ covers $X$.}}
        \step{b}{\pflet{$A = X - V_1 - \cdots - V_k - U_{k+2} - \cdots - U_n$}}
        \step{c}{$A$ is closed and $A \subseteq U_{k+1}$}
        \step{d}{\pick\ $V_{k+1}$ open such that $A \subseteq V_{k+1}$ and $\overline{V_{k+1}} \subseteq U_{k+1}$}
    \end{proof}
