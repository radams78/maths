...
\begin{example}
    The set $\RR^\omega$ is disconnected under the uniform and box topologies. Under either topology, the set of bounded sequences and the set of unbounded sequences form
    a separation.
\end{example}
...
\begin{definition}[The Long Line]
    The \emph{long line} is the space $S_\Omega \times [0,1)$ in the dictionary order
