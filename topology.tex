...
\begin{proof}
    \pf
    \step{0}{\pick\ a countable local bases $\{ B_n \mid n \in \ZZ^+ \}$ at $l$.}
    \step{1}{For all $n \geq 1$, \pick\ $a_n \in A \cap B_1 \cap \cdots \cap B_n$
    \prove{$a_n \rightarrow l$ as $n \rightarrow \infty$}}
    \step{2}{\pflet{$U$ b a neighbourhood of $A$}}
    \step{3}{\pick\ $N$ such that $B_N \subseteq A$}
