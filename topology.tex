...
\begin{theorem}
    ...
    continuous functions $X \rightarrow \RR$ such that, for every $x_0 \in X$
    and open neighbourhood $U$ of $x_0$, there exists $\alpha \in J$ such that
    $f_\alpha(x_0) > 0$ and $f_\alpha$ vanishes outside $U$. Define $F : X
    \rightarrow \RR^J$ by
